...
This builds and starts two containers: `dynamodb-local` and `app` (port 8000).

## Seeing It In Action

Once the containers start up, the service will be available at `http://localhost:8000`.
