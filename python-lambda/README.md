...
A Python service deployed on AWS Lambda, with Trace0 installed for observability. The service includes:
...
```bash
curl --location 'https://xwq9hz28xb.execute-api.eu-west-1.amazonaws.com/dev/users' \
...
```bash
curl --location 'https://xwq9hz28xb.execute-api.eu-west-1.amazonaws.com/dev/users/usr_1780350129882_9bq2bp6'
```
