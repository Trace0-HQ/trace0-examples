...
```bash
curl --location 'http://ec2-3-252-230-167.eu-west-1.compute.amazonaws.com:8000/users' \
...
```bash
curl --location 'http://ec2-3-252-230-167.eu-west-1.compute.amazonaws.com:8000/users/8b258bc7-3d48-4ee8-929e-0014762b0163'
```
