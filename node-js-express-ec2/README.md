...
```bash
curl --location 'http://ec2-3-249-124-1.eu-west-1.compute.amazonaws.com:3000/users' \
...
```bash
curl --location 'http://ec2-3-249-124-1.eu-west-1.compute.amazonaws.com:3000/users/usr_1780264249725_02snrqo'
```
