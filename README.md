...
* [Python FastAPI EC2](python-fast-api-ec2/) - A Python FastAPI service deployed on EC2.
* [Java AWS Lambda](java-lambda/) - A Java service deployed on AWS Lambda.
* [Java Spring Boot](java-spring-boot/) - A Java Spring Boot service deployed on EC2.
