...
```bash
curl --location 'https://mrg3f00yzh.execute-api.eu-west-1.amazonaws.com/dev/users' \
...
```bash
curl --location 'https://mrg3f00yzh.execute-api.eu-west-1.amazonaws.com/dev/users/usr_1780251350002_b99c6ac'
```
